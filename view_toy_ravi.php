...
<!--//header-->
	...
	<table id='tableContainerFiltered1' name='tableContainerFiltered1' class="footable title-info wow fadeInUp animated" data-wow-delay=".5s">
		<thead> 
			<tr>
				<th data-class='expand'>Toy Name</th>
				<th>Code</th>
