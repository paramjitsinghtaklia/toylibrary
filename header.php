	...
	<div class="header">
		<div class="top-header navbar navbar-default"><!--header-one-->
			<div class="container">
				...
				<div class="nav navbar-nav navbar-right social-icons"><a href="index.php" style="cursor:pointer !important; color:#c6178d;"><strong>Logout</a></strong></a></div>
						...
						<ul class="nav navbar-nav top-nav-info">
									...
									<div class="row">
										...
										<div class="col-sm-3 menu-grids"> 
											...
											<ul class="multi-column-dropdown ">
												...
												<li><a class="list" href="add_benefits.php">Add Toy Benefits</a></li>
											</ul>
										</div>
										<?php 
										}
										...
										<div class="col-sm-3 menu-grids">
											...
											<ul class="multi-column-dropdown">
												...
												<li><a class="list" href="view_benefits.php">View/Update Toy Benefits</a></li>
											</ul>
										</div>																
										<div class="clearfix"> </div>
									</div>
								...
								<ul class="dropdown-menu multi-column multi-column2">
									<div class="row">
										<div class="col-sm-3 menu-grids">
											...
											?>
												<li><a class="list" href="assigntoy_customer.php">Assign/Block Toy For Customer</a></li>
									...
									<div class="row">
										<div class="col-sm-3 menu-grids"> 
											...
											<ul class="multi-column-dropdown ">
												...
												<li><a class="list" href="add_order_parties.php">Add Order (Party Seller)</a></li>
												<li><a class="list" href="add_order_selltoy.php">Add Order (Selling)</a></li>
										...
										<div class="col-sm-3 menu-grids">
											...
											<ul class="multi-column-dropdown">
												...
												<li><a class="list" href="view_order_parties.php">View Order List(Party)</a></li>
												<li><a class="list" href="view_order_buy.php">View Order List(Buy)</a></li>
							...
							<li class="dropdown grid">
								...
								<ul class="dropdown-menu multi-column menu-two multi-column3">
									<div class="row">
										<div class="col-sm-3 menu-grids">
											<h4>Pettycash Management</h4>
											<ul class="multi-column-dropdown">
										<?php
											if ($_SESSION["user_role"]=="admin")
											{
										?>
												<li><a class="list" href="add_pettycash_amount.php">Add Pettycash</a></li>
												<li><a class="list" href="view_pettycash_amount.php">View/Update Pettycash</a></li>
												<li><a class="list" href="add_expense.php">Add Expenses</a></li>
												<li><a class="list" href="view_expense_amount.php">View/Update Expenses</a></li>
												<li><a class="list" href="add_income.php">Add Income</a></li>
												<li><a class="list" href="view_income.php">View/Update Income</a></li>
									...
									?>
										<div class="col-sm-3 menu-grids">
											...
											<ul class="multi-column-dropdown">
												<li><a class="list" href="search_income_report.php">Income Report</a></li>
												<li><a class="list" href="#">Expense Report</a></li>
												<li><a class="list" href="#">Rent Report</a></li>
												<li><a class="list" href="#">Toy Sell Report</a></li>
												<li><a class="list" href="#">Party Supplier Rent Report</a></li>
											</ul>
										</div>																		
										<div class="col-sm-3 menu-grids">
