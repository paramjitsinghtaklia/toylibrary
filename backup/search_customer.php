					...
					<table class="table" width="100%" border="0">
						<tr  style="background:none;">
							<td align="left"><h3 style="margin-top: -18px;font-weight:bold;margin-bottom: 13px;">Customer Name :</h3>
								<input type="text" ng-model="cust_name" type="text" name="cust_name" id="cust_name" required="true" style="margin-bottom:0; background:#f1f1f1" value="Test"  />
							</td>
							<td align="left"><h3 style="margin-top: -18px;font-weight:bold;margin-bottom: 13px;">E-mail ID :</h3>
								<input type="text" ng-model="email_id" type="text" name="email_id" id="email_id" required="true" style="margin-bottom:0; background:#f1f1f1" value="test@gmail.com"  />
							</td>
							<td align="left"><h3 style="margin-top: -18px;font-weight:bold;margin-bottom: 13px;">Child Name :</h3>
								<input type="text" ng-model="cname" type="text" name="cname" id="cname" required="true" style="margin-bottom:0; background:#f1f1f1" value="" />
							</td>
						</tr>
							<tr style="background:none;">
							<td align="left">
							...
							<td align="left">
							<button ng-click="custList()" class="btn_user" style=" width: 50%; float: right; color: #fff; font-size: 20px;">Search</button>
							</td>
						</tr>
					</table>
					<table width="98%">
