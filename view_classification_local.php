...
<link href="css/footable-0.1.css" rel="stylesheet" type="text/css" /> 
	...
	<div class="login-page" style="width: 100%! important;">
		<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
			<h3 class="title" style="border-bottom: 3px solid;padding-bottom: 10px;margin-top: -26px;margin-bottom: -30px;">View/Update<span> Classification/Category</span></h3>
		</div>
			 <style>
				.table_list {
...
<table id='tableContainerFiltered1' name='tableContainerFiltered1' class='footable'  data-filtering="true" >
     <thead> <tr ><th data-class='expand'>Category Name</th>
      <th>Status</th>
