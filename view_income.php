...
$result_data = $objincome->getIncomeamount(); 
...
<script src="js/footable.filtering.js" type="text/javascript"></script>
	...
	<div class="login-page" style="width: 100%! important;">
		<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
			<h3 class="title" style="border-bottom: 3px solid;padding-bottom: 10px;margin-top: -26px;margin-bottom: -30px;">View/Update<span> Income</span> <div style="float:right;margin-left: -13%;margin-right: 2%;"><a href="add_income.php" style="text-decoration:none; color:#fff;"><button class="btn_add" style="font-size: 23px;margin-top: 10px;padding-top: 11px;padding-bottom: 11px;">Add Income</button></a></div></h3>
		</div>
