...
<div class="login-page" style="width:90%" >
	<div class="title-info wow fadeInUp animated" data-wow-delay=".5s" style="">
		<h3 class="title" style="border-bottom: 3px solid;padding-bottom: 10px;margin-top: -26px;margin-bottom: -30px;width: 100%;margin-left: 0;">Expense <span> Report</span><div style="float:right;margin-left: -13%;margin-right: 2%;"><!--<a href="#" style="text-decoration:none; color:#fff;"><button class="btn_add" style="font-size: 23px;margin-top: 0;padding-top: 11px;padding-bottom: 11px;">View Income</button></a>--></div></h3>
	</div>
		...
		<div class="login-body">
			<?php 
				...
				if ($_SERVER['REQUEST_METHOD']=="POST")
				{
					...
					$result_data = $objexpenses->getexpense_report($_POST['expense_type'],$_POST['from_date'],$_POST['to_date']); 
				}
			?>
					...
					<table style="width:100%;">
						<tr style="background:none; margin-top:20px;">
							<td align="left"><h3 style="margin-top: -18px;font-weight:bold;margin-bottom: 13px;">Expense Type :</h3>
								<select name="expense_type" required="true" id="expense_type" class="select_brand" >
