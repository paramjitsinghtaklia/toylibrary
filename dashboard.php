...
$countrowrent = $objtoy->GetToysRentCount();
$countorderclose = $objtoy->GetOrderCloseCount();
$totalpettycase = $objtoy->GetPettyCaseAmnt();
$todaysexpense = $objtoy->GetExpenseAmnt();
$todayrentamont = $objtoy->GetTodaysRentAmnt();
$todaysellamont = $objtoy->GetTodaysSellAmnt();
 ?>
<!--//header-->
	<!--banner-->
	<div class="banner">
		<div class="container" style="width:90%">
			<div class="" style="color:#fff; height:auto; text-align:center">			
				...
				.td_text:hover{background:#000; color:#fff;}
				.a_link{ text-decoration:none; color:#fff !important;}
				</style>
				<table style="width:100%; height:auto; margin-top:5px; opacity:0.95;" border="0" class="table">
					<tr>
						...
						<td width="33%">
							<table style="width:100%" class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".5s">
								<tr>
									<td class="td_count"><?php echo $countrowrent['total'];?></td>
								</tr>
								<tr>
						...
						<td width="33%">
							<table style="width:100%" class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".5s">
								<tr>
									<td class="td_count"><?php echo $countorderclose['total'];?></td>
								</tr>
								<tr>
					...
					<tr>
						...
						<td width="33%">
							<table style="width:100%" class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".5s">
								<tr>
									<td class="td_count"><i class="fa fa-inr"></i><?php echo $totalpettycase['total'];?></td>
								</tr>
								<tr>
						...
						<td width="33%">
							<table style="width:100%" class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".5s">
								<tr>
									<td class="td_count"><i class="fa fa-inr"></i><?php if($todaysexpense!='') echo $todaysexpense['total']; else echo '0'; ?></td>
								</tr>
								<tr>
					...
					<tr>
						<td width="33%">
							<table style="width:100%" class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".5s">
								<tr>
									<td class="td_count"><i class="fa fa-inr"></i><?php if($todayrentamont!='') echo $todayrentamont['total']; else echo '0'; ?></td>
								</tr>
								<tr>
						...
						<td width="33%">
							<table style="width:100%" class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".5s">
								<tr>
									<td class="td_count"><i class="fa fa-inr"></i><?php if($todaysellamont!='') echo $todaysellamont['total']; else echo '0'; ?></td>
								</tr>
								<tr>
