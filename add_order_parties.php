...
{
	$objOrder = new order();
	$output = $objOrder->AddPartyOrder($_POST);
...
<script src="js/jquery.validate.min.js"></script>
	...
	<div class="login-page" style="width:95%;" ng-app='toysearch' ng-controller='toylisting' >
		<div class="title-info wow fadeInUp animated" data-wow-delay=".5s" style="">
			<h3 class="title" style="border-bottom: 3px solid;padding-bottom: 10px;margin-top: -26px;margin-bottom: -30px;">Add (Party Seller)<span> Order</span><div style="float:right;margin-left: -13%;margin-right: 2%;"><a href="view_order_parties.php" style="text-decoration:none; color:#fff;"><button class="btn_add" style="font-size: 23px;margin-top: 10px;padding-top: 11px;padding-bottom: 11px;">View Orders</button></a></div></h3>
		</div>
			  ...
			  <form class="wow fadeInUp animated" data-wow-delay=".5s" name="addorder" id="addorder" action="" method="POST" enctype="multipart/form-data">
					...
					<table class="table" width="100%" border="0">
						<tr>
							...
							<td align="left"><h3 style="margin-top: -18px;font-weight:bold;margin-bottom: 13px;">Order type :</h3>
								<select name="order_type" id="order_type" required="true" class="select_brand">
									...
									<option selected value="party">Party Order</option>
						...
						<tr style="background:none;">
							...
							<td align="left"> 
							<h3 style="margin-top: -18px;font-weight:bold;margin-bottom: 13px;">Total Amount:</h3>
								<input type="text" name="order_amount" id="order_amount" required="true" style="margin-bottom:0;"  value="{{rent_amount}}"  />
							</td>
						</tr>
